...
public class GoodsControllerTestJumpToGoodsActivityDetailByGoodsId extends BaseTest {
    ...
    public void TestGoodUnCheck() throws Exception {
        ...
        JumpToGoodsActivityDetailByGoodsId page = new JumpToGoodsActivityDetailByGoodsId();
        page.GoodsUnCheck(driver, mockGoodsA.getId());
    }
    ...
    public void TestDown() {
        ...
        JumpToGoodsActivityDetailByGoodsId page = new JumpToGoodsActivityDetailByGoodsId();
        page.GoodsDown(driver, mockGoodsA.getId());
    }
    ...
    public void TestExpired() throws Exception {
        ...
        JumpToGoodsActivityDetailByGoodsId page = new JumpToGoodsActivityDetailByGoodsId();
        page.Expired(driver, mockGoodsA.getId());
    }
    ...
    public void TestNotStart() throws Exception {
        ...
        mockGoodsA.setEndTime(new SimpleDateFormat("yyyy-MM-dd hh:mm:ss").parse("2019-03-27 00:00:00"));
        JumpToGoodsActivityDetailByGoodsId page = new JumpToGoodsActivityDetailByGoodsId();
        page.NotStart(driver, mockGoodsA.getId());
    }
